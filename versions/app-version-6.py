...
# Function to create SNR Histogram, Bar Chart, and NEP Bar Chart
def data_quality_check(data):
    # Assuming 'data' is a DataFrame containing voltage data and dark data

    # SNR calculation dictionary
    signal_dark_dictionary = {
        'LED_A_784_DET1':'LED_A_DARK_DET1', 'LED_A_800_DET1':'LED_A_DARK_DET1', 'LED_A_818_DET1':'LED_A_DARK_DET1', 
        'LED_A_835_DET1':'LED_A_DARK_DET1', 'LED_A_851_DET1':'LED_A_DARK_DET1', 'LED_A_881_DET1':'LED_A_DARK_DET1',
        'LED_A_784_DET2':'LED_A_DARK_DET2', 'LED_A_800_DET2':'LED_A_DARK_DET2', 'LED_A_818_DET2':'LED_A_DARK_DET2', 
        'LED_A_835_DET2':'LED_A_DARK_DET2', 'LED_A_851_DET2':'LED_A_DARK_DET2', 'LED_A_881_DET2':'LED_A_DARK_DET2',
        'LED_A_784_DET3':'LED_A_DARK_DET3', 'LED_A_800_DET3':'LED_A_DARK_DET3', 'LED_A_818_DET3':'LED_A_DARK_DET3', 
        'LED_A_835_DET3':'LED_A_DARK_DET3', 'LED_A_851_DET3':'LED_A_DARK_DET3', 'LED_A_881_DET3':'LED_A_DARK_DET3',
        'LED_B_784_DET1':'LED_B_DARK_DET1', 'LED_B_800_DET1':'LED_B_DARK_DET1', 'LED_B_818_DET1':'LED_B_DARK_DET1', 
        'LED_B_835_DET1':'LED_B_DARK_DET1', 'LED_B_851_DET1':'LED_B_DARK_DET1', 'LED_B_881_DET1':'LED_B_DARK_DET1',
        'LED_B_784_DET2':'LED_B_DARK_DET2', 'LED_B_800_DET2':'LED_B_DARK_DET2', 'LED_B_818_DET2':'LED_B_DARK_DET2', 
        'LED_B_835_DET2':'LED_B_DARK_DET2', 'LED_B_851_DET2':'LED_B_DARK_DET2', 'LED_B_881_DET2':'LED_B_DARK_DET2',
        'LED_B_784_DET3':'LED_B_DARK_DET3', 'LED_B_800_DET3':'LED_B_DARK_DET3', 'LED_B_818_DET3':'LED_B_DARK_DET3', 
        'LED_B_835_DET3':'LED_B_DARK_DET3', 'LED_B_851_DET3':'LED_B_DARK_DET3', 'LED_B_881_DET3':'LED_B_DARK_DET3'
    }

    # Calculate SNR for all the columns in signal-dark dictionary
    snr_dict = {}
    ...
    'data': [
        go.Histogram(
            ...
            name='SNR Histogram',
            textposition='inside',  # Places the text inside the bars
            hovertemplate='SNR: %{x}<br>Frequency: %{y}<extra></extra>'  # Hover text with SNR and Frequency
        )
    ],
    'layout': go.Layout(
        title='Histogram of SNR for All Columns',
        xaxis=dict(title='SNR'),
        yaxis=dict(title='Frequency'),
        height=800,
        annotations=[
            dict(
                x=0.5,  # Position of the annotation in x-axis coordinates
                y=1.05,  # Position of the annotation in y-axis coordinates
                xref="paper",  # Use "paper" to refer to the entire plot area
                yref="paper",
                showarrow=False,
    ...
    # 2. SNR Bar Chart Plot
    snr_bar_chart = {
        'data': [
            go.Bar(
                x=list(snr_dict.keys()),
                y=list(snr_dict.values()),
                marker=dict(color='skyblue'),
                name='SNR Bar Chart'
            )
        ],
        'layout': go.Layout(
            title='SNR for Each Column',
    ...
    # 3. NEP Bar Chart Plot
    nep_values = [
        np.std(data['LED_A_DARK_DET1']), np.std(data['LED_A_DARK_DET2']), np.std(data['LED_A_DARK_DET3']),
        np.std(data['LED_B_DARK_DET1']), np.std(data['LED_B_DARK_DET2']), np.std(data['LED_B_DARK_DET3'])
    ]
    nep_fig = {
        'data': [
            go.Bar(
                x=['GroupA_Detector1', 'GroupA_Detector2', 'GroupA_Detector3', 'GroupB_Detector1', 'GroupB_Detector2', 'GroupB_Detector3'],
                y=nep_values,
                text=nep_values,
